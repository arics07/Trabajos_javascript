...
let verdadero = true;
let texto = "Helado de pistacho";
let numero = 17;
let nada = null;

let operacionMatematica = numero*10;
console.log("17 x 10 = " + operacionMatematica);

let stringsConcatenados = texto + " y Helado de dulce de leche"
console.log(stringsConcatenados);

let mensaje = verdadero ? "Es verdadero!!" : "Es falso, buuuu.";
console.log(mensaje);

let vacio = (nada === null) ? "Hay una variable vacía!!" : "No hay variables vacias ;)";
console.log(vacio);
